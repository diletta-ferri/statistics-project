...
#questa è quella che c'è nell'ultimo pipeline aggiornato
...
for (encoder in enc_1){# per ogni dataset, ogni encoding
...
saveRDS(dataset_risultati, file = "nome_del_dataset_risultati.rds")